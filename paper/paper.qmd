...
\begin{itemize}
    \item \( x_{1i} \): The carat size of the diamond (in carats).
    \item \( x_{2i} \): The color grade of the diamond (categorical).
    \item \( x_{3i} \): The cut grade of the diamond (categorical).
    \item \( x_{4i} \): The clarity grade of the diamond (categorical).
\end{itemize}
...
2. **Link Function**:  
   ...
   + \sum_{j} \beta_{2j} \cdot \text{color}_{ij} \nonumber \\
   &\quad + \sum_{k} \beta_{3k} \cdot \text{cut}_{ik} 
   + \sum_{l} \beta_{4l} \cdot \text{clarity}_{il}.
   \end{align}
...
3. **Mean Price**:  
   \begin{align}
   \mu_i &= \exp\left(\beta_0 + \beta_1 x_{1i} 
   + \sum_{j} \beta_{2j} \cdot \text{color}_{ij} \right. \nonumber \\
   &\quad \left.+ \sum_{k} \beta_{3k} \cdot \text{cut}_{ik} 
   + \sum_{l} \beta_{4l} \cdot \text{clarity}_{il}\right).
   \end{align}
